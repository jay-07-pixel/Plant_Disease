"""Training report generation for the EfficientNet-B3 transfer-learning experiment."""
...
from experiments.efficientnet_b3.config import DEFAULT_STAGE1_EPOCHS, REPORT_JSON, REPORT_MD
from experiments.efficientnet_b3.evaluate import EvaluationResult, evaluation_result_to_dict
...
def build_training_report(
    *,
    ...
    """Build the complete EfficientNet-B3 training report payload."""
...
def save_training_report_markdown(report: dict[str, Any], output_path: Path | str = REPORT_MD) -> Path:
    ...
    lines = [
        "# EfficientNet-B3 Transfer Learning Training Report",
        "",
        ...
        f"| 2 — Fine-tuning | {stages.get('stage2_epochs', 'N/A')} | {stages.get('stage2_learning_rate', 'N/A')} | last feature stage + classifier |",
        "",
        "| Parameter | Value |",
        "|-----------|------:|",
    ...
    lines.extend(
        [
            ...
            "| File | Description |",
            "|------|-------------|",
            "| `saved_models/efficientnet_b3/best_model.pth` | Best validation checkpoint |",
            "| `saved_models/efficientnet_b3/last_model.pth` | Last epoch checkpoint |",
            "| `saved_models/efficientnet_b3/stage1_best_model.pth` | Best Stage 1 checkpoint |",
            "| `saved_models/efficientnet_b3/training_history.json` | Combined training history |",
            "| `experiments/efficientnet_b3/tensorboard/` | TensorBoard event files |",
            "",
        ]
    )
