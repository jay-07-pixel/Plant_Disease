"""Training report generation for the ResNet101 transfer-learning experiment."""
...
from experiments.resnet101.config import DEFAULT_STAGE1_EPOCHS, REPORT_JSON, REPORT_MD
from experiments.resnet101.evaluate import EvaluationResult, evaluation_result_to_dict
...
def build_training_report(
    *,
    ...
    """Build the complete ResNet101 training report payload."""
...
def save_training_report_markdown(report: dict[str, Any], output_path: Path | str = REPORT_MD) -> Path:
    ...
    lines = [
        ...
        f"| 2 — Fine-tuning | {stages.get('stage2_epochs', 'N/A')} | {stages.get('stage2_learning_rate', 'N/A')} | layer4 + classifier |",
        "",
        "| Parameter | Value |",
        "|-----------|------:|",
