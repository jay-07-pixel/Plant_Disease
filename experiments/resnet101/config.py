"""ResNet101 transfer-learning experiment configuration."""
...
EXPERIMENT_ROOT = Path("experiments/resnet101")
SAVE_DIR = Path("saved_models/resnet101")
TENSORBOARD_DIR = EXPERIMENT_ROOT / "tensorboard"
HISTORY_PATH = SAVE_DIR / "training_history.json"
BEST_MODEL_PATH = SAVE_DIR / "best_model.pth"
LAST_MODEL_PATH = SAVE_DIR / "last_model.pth"
REPORT_JSON = Path("reports/resnet101_training_report.json")
REPORT_MD = Path("reports/resnet101_training_report.md")
...
@dataclass
class ResNet101ExperimentConfig:
    """Experiment-level settings for the ResNet101 transfer-learning run.
...
def build_stage_experiment(
    ...
    *,
    ...
    return ResNet101ExperimentConfig(
...
def build_engine_config(
    ...
    *,
    ...
    """Build a :class:`TrainingEngineConfig` for the ResNet101 experiment.
