"""EfficientNet-B0 transfer-learning experiment configuration."""
...
EXPERIMENT_ROOT = Path("experiments/efficientnet_b0")
SAVE_DIR = Path("saved_models/efficientnet_b0")
TENSORBOARD_DIR = EXPERIMENT_ROOT / "tensorboard"
HISTORY_PATH = SAVE_DIR / "training_history.json"
BEST_MODEL_PATH = SAVE_DIR / "best_model.pth"
LAST_MODEL_PATH = SAVE_DIR / "last_model.pth"
REPORT_JSON = Path("reports/efficientnet_b0_training_report.json")
REPORT_MD = Path("reports/efficientnet_b0_training_report.md")
...
@dataclass
class EfficientNetB0ExperimentConfig:
    """Experiment-level settings for the EfficientNet-B0 transfer-learning run.
...
def build_stage_experiment(
    ...
    *,
    ...
    return EfficientNetB0ExperimentConfig(
...
def build_engine_config(
    ...
    *,
    ...
    """Build a :class:`TrainingEngineConfig` for the EfficientNet-B0 experiment.
