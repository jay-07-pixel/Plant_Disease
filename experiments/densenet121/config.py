"""DenseNet121 transfer-learning experiment configuration."""
...
EXPERIMENT_ROOT = Path("experiments/densenet121")
SAVE_DIR = Path("saved_models/densenet121")
TENSORBOARD_DIR = EXPERIMENT_ROOT / "tensorboard"
HISTORY_PATH = SAVE_DIR / "training_history.json"
BEST_MODEL_PATH = SAVE_DIR / "best_model.pth"
LAST_MODEL_PATH = SAVE_DIR / "last_model.pth"
REPORT_JSON = Path("reports/densenet121_training_report.json")
REPORT_MD = Path("reports/densenet121_training_report.md")
...
@dataclass
class DenseNet121ExperimentConfig:
    """Experiment-level settings for the DenseNet121 transfer-learning run.
...
def build_stage_experiment(
    ...
    *,
    ...
    return DenseNet121ExperimentConfig(
...
def build_engine_config(
    ...
    *,
    ...
    """Build a :class:`TrainingEngineConfig` for the DenseNet121 experiment.
