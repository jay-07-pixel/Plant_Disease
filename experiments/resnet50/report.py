"""Training report generation for the ResNet50 transfer-learning experiment."""
...
from experiments.resnet50.config import DEFAULT_STAGE1_EPOCHS, REPORT_JSON, REPORT_MD
from experiments.resnet50.evaluate import EvaluationResult, evaluation_result_to_dict
...
def build_training_report(
    *,
    ...
    """Build the complete ResNet50 training report payload."""
