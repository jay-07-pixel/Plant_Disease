"""ResNet50 transfer-learning experiment configuration."""
...
EXPERIMENT_ROOT = Path("experiments/resnet50")
SAVE_DIR = Path("saved_models/resnet50")
TENSORBOARD_DIR = EXPERIMENT_ROOT / "tensorboard"
HISTORY_PATH = SAVE_DIR / "training_history.json"
BEST_MODEL_PATH = SAVE_DIR / "best_model.pth"
LAST_MODEL_PATH = SAVE_DIR / "last_model.pth"
REPORT_JSON = Path("reports/resnet50_training_report.json")
REPORT_MD = Path("reports/resnet50_training_report.md")
...
@dataclass
class ResNet50ExperimentConfig:
    """Experiment-level settings for the ResNet50 transfer-learning run.
...
def build_stage_experiment(
    ...
    *,
    ...
    return ResNet50ExperimentConfig(
...
def build_engine_config(
    ...
    *,
    ...
    """Build a :class:`TrainingEngineConfig` for the ResNet50 experiment.
